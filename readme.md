...
- Если интересует внедрение в команду и кодовую базу, откройте `book/16_архитектура_кода.md` и `book/23_как_начать.md`.
- Если интересует оценка качества и безопасность, смотрите `book/14_оценка_качества_llm_систем.md` и `book/15_безопасность_llm_систем.md`.
