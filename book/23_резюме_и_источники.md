...
| # | Автор(ы) | Год | Название | Вклад |
|---|----------|-----|----------|-------|
| 64 | Leviathan et al. | 2022 | *Fast Inference from Transformers via Speculative Decoding* | Speculative decoding; ICML 2023 |
| 65 | Kwon et al. | 2023 | *Efficient Memory Management for LLM Serving with PagedAttention* | PagedAttention / vLLM; SOSP 2023 |
| 66 | Gim et al. | 2023 | *Prompt Cache: Modular Attention Reuse for Low-Latency Inference* | Prompt Cache; MLSys 2024 |
...
| 68 | Lou et al. | 2023 | *Discrete Diffusion Modeling by Estimating the Ratios of the Data Distribution* | SEDD; ICML 2024 |
...
Подробный разбор модельного ландшафта, архитектурных трендов и экономики inference — в [Главе 22 (Ландшафт 2026)](22_ландшафт_2026.md). Здесь — ключевой принцип:
