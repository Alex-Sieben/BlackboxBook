...
| Cohere `embed-v4` | 1536 (по умолчанию; сжимаемо до 256) | 128K токенов | Мультимодальные (текст + изображения + PDF), search/classification |
...
| Voyage `voyage-4-large` | 1024 (Matryoshka: 256/512/2048) | 32K токенов | Серия voyage-4 (large/base/lite), code-aware |
...
- Верификация постфактум — второй вызов или regex-проверка наличия citation (см. [Главу 13](13_антигаллюцинационный_контур.md)).
