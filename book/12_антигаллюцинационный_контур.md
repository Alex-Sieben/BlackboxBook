...
- Две разные модели (generator = GPT-4o, verifier = Claude Opus 4).
...
### 12.3.1. Платформы наблюдаемости (Observability) в 2026
...
|-----------|------------|-------------|
| **Guardrails AI** | Валидация структуры и содержания output'ов | Декларативные правила на RAIL XML/Pydantic, авто-retry |
...
### 12.5.1. Детекция prompt injection
...
### 12.5.3. Выходные guardrails (расширенные)
...
## 12.6. Цена верификации: баланс точности, задержки и стоимости
...
## 12.7. Продакшн-мониторинг: дашборд на каждый день
